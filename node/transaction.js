...
class Transaction {
  ...
  /**
   *  Вызывается в том случае, если транзакция имет инпуты на которые нельзя ссылаться дважды в одном блоке
   * 
   *  @param {Transaction[]} otherTxs - кандидаты на попадание в один блок
   */
